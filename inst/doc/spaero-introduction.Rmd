...
\hline birth of a susceptible & $(1,0,0)$ & $ N_0 (\mu + \mu_t) $\\
...
\begin{table}[h] \caption{Formulas for statistics at windows in terms of moment estimates.}  \label{tstats}
\begin{tabular}{ll}
\hline
Statistic & Formula\\
\hline
...
$\textrm{autocovariance}_i$ & $m_i( (x_j - \textrm{mean}_j) (x_{j - \textrm{lag}} - \textrm{mean}_{j -\textrm{lag}}))$ \\
$\textrm{autocorrelation}_i$ & $\textrm{autocovariance}_i / \textrm{variance}_i$ \\
...
estimated statistics.  First we try a Gaussian window.
